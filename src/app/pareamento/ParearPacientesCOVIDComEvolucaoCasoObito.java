...
public class ParearPacientesCOVIDComEvolucaoCasoObito {
	...
	public static void main(String[] args) throws Exception {
		...
		pareamento.carregarArquivosCSV("./arquivos/csv/sivep/obito/SIVEP-MG(OBITO).csv", 
				                       "./arquivos/csv/sus/SUS-MG(ComDataTesteEIdade).csv");
		...
		pareamento.parearPacientesEntreSivepESus(25, 
					                             ...
					                             "./arquivos/csv/sivep/obito/SUS-MG(OBITO-PacientesUsadosEntre25E45Anos).csv",
					                             "./arquivos/csv/sivep/obito/SUS-MG(OBITO-PacientesNaoUsadosEntre25E45Anos).csv");
		...
		pareamento.parearPacientesEntreSivepESus(46, 
					                             ...
					                             "./arquivos/csv/sus/obito/SUS-MG(OBITO-PacientesUsadosEntre46E57Anos).csv",
					                             "./arquivos/csv/sus/obito/SUS-MG(OBITO-PacientesNaoUsadosEntre46E57Anos).csv");
		...
		pareamento.parearPacientesEntreSivepESus(58, 
								                 ...
								                 "./arquivos/csv/sus/obito/SUS-MG(OBITO-PacientesUsadosEntre58E78Anos).csv",
								                 "./arquivos/csv/sus/obito/SUS-MG(OBITO-PacientesNaoUsadosEntre58E78Anos).csv");
